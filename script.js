...
function handleRegistration() {
  ...
  const GOOGLE_SHEET_URL =
    "https://script.google.com/macros/s/AKfycbywI3Zw92_blCQOhnej5a-OwCeyMeZca9erqryh5qjwy0HLW6DtBbps99vBDTbjXbdP/exec";
  ...
  fetch(GOOGLE_SHEET_URL, {
    ...
    .catch((error) => {
      ...
      // Still show success because no-cors mode can't read the response
      // The data likely went through even if we get an opaque response
      document.querySelector(".reg-fields").style.display = "none";
      document.querySelector(".reg-form-header").style.display = "none";
      btn.style.display = "none";
      document.querySelector(".reg-note").style.display = "none";
