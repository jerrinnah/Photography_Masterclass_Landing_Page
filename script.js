...
const MODULES = [
  {
    part: "PART ONE", partTitle: "FOUNDATIONS", tag: "BEGINNER",
    chapters: [
      { num: "01", title: "Understanding Photography", lessons: "4 Lessons + 4 Exercises", topics: [
      ...
      { num: "02", title: "Camera Types and Equipment", lessons: "5 Lessons + 2 Exercises", topics: [
      ...
      { num: "03", title: "The Exposure Triangle", lessons: "6 Lessons + 5 Exercises", topics: [
  ...
  {
    part: "PART ONE (continued)", partTitle: "FOUNDATIONS", tag: "BEGINNER \u2013 INTERMEDIATE",
    chapters: [
      { num: "04", title: "Composition and Visual Storytelling", lessons: "7 Lessons + 7 Exercises", topics: [
      ...
      { num: "05", title: "Understanding Light", lessons: "9 Lessons + 8 Exercises", topics: [
  ...
  {
    part: "PART TWO", partTitle: "BUILDING YOUR CRAFT", tag: "INTERMEDIATE",
    chapters: [
      { num: "06", title: "Lenses and Their Creative Applications", lessons: "5 Lessons + 3 Exercises", topics: [
      ...
      { num: "07", title: "Post-Processing and Editing", lessons: "6 Lessons + 4 Exercises", topics: [
  ...
  {
    part: "PART TWO (continued) + PART THREE", partTitle: "GENRE MASTERY + ADVANCED TECHNIQUES", tag: "INTERMEDIATE \u2013 ADVANCED",
    chapters: [
      { num: "08", title: "Genre Mastery", lessons: "7 Lessons + 5 Exercises", topics: [
      ...
      { num: "09", title: "Advanced Lighting Techniques", lessons: "6 Lessons + 5 Exercises", topics: [
      ...
      { num: "10", title: "Advanced Composition and Creative Vision", lessons: "5 Lessons + 4 Exercises", topics: [
      ...
      { num: "11", title: "Advanced Post-Processing", lessons: "6 Lessons + 5 Exercises", topics: [
  ...
  {
    part: "PART FOUR", partTitle: "THE BUSINESS OF PHOTOGRAPHY", tag: "ALL LEVELS",
    chapters: [
      { num: "12", title: "Building Your Photography Business in Nigeria", lessons: "6 Lessons + 5 Exercises", topics: [
      ...
      { num: "13", title: "Scaling Your Photography Income", lessons: "4 Lessons + 3 Exercises", topics: [
      ...
      { num: "14", title: "Your Digital Presence and Personal Brand", lessons: "3 Lessons + 2 Exercises", topics: [
      ...
      { num: "15", title: "Ethics, Legal Considerations, and Professional Standards", lessons: "4 Lessons + 3 Exercises", topics: [
      ...
      { num: "16", title: "The Road Ahead", lessons: "Your Final Assignment", topics: [
...
const TESTIMONIALS = [
  { name: "Chidera O.", location: "Lagos", text: "I went from charging N30K for weddings to N250K in 4 months. Jay did not just teach photography. He taught me how to run a business." },
  { name: "Emeka A.", location: "Abuja", text: "The lighting module alone is worth 10x the price. I finally understand flash and my event photos look completely different now." },
  { name: "Blessing I.", location: "PH", text: "I started with just my phone. The composition and light modules helped me build a portfolio that landed my first 3 paying clients." },
  { name: "Tunde M.", location: "Ibadan", text: "The business module changed everything. I had the skills but was broke. Now I have contracts, deposits, and actual profit margins." },
];

const FAQ_DATA = [
  { q: "I am a complete beginner. Is this for me?", a: "Absolutely. Part One starts from zero: what photography is, understanding your camera, the exposure triangle. By Part Four, you are registering a business, writing contracts, and pricing in Naira. The course is designed to take you from wherever you are to wherever you want to go." },
  { q: "What camera do I need?", a: "Whatever you have, even a smartphone. Chapter 2 covers every camera type honestly, and the exercises are designed to work with any device. When you are ready to invest, the course includes a full Nigerian equipment buying guide with prices and where to buy." },
  { q: "How is this different from free YouTube tutorials?", a: "YouTube teaches scattered techniques. This is a structured 16-chapter system that builds skill on top of skill, with 60+ real Nigerian examples, 45+ hands-on exercises, business templates, and pricing frameworks. It is the difference between random tips and a complete education." },
  { q: "How long do I have access?", a: "Lifetime. Once you enrol, the course is yours forever. Watch at your own pace, rewatch as many times as you need, and access all future updates at no extra cost." },
  { q: "Can I really make money from photography in Nigeria?", a: "Chapter 12 and 13 prove it with real numbers. The course includes actual pricing tables, cost breakdowns, revenue projections, and multiple income stream strategies all built for the Nigerian market." },
  { q: "Is the pricing in Naira?", a: "Yes. \u20A615,000 flat. Payment via Paystack, Flutterwave, or bank transfer. No dollar conversions, no hidden fees, no recurring charges." },
  { q: "Is there a community or support?", a: "Yes. You get access to our private community of students where you can share work, get feedback, and ask questions. You are not learning alone." },
];

const DIFF_DATA = [
  ["100% Nigerian", "Every example is from Nigeria. Balogun Market, Oshodi, Third Mainland Bridge, Computer Village. Pricing in Naira. Equipment guides for Lagos. Business registration through CAC. This was not adapted for Nigeria. It was born here."],
  ["Beginner to Business Owner", "Part One teaches you what a camera is. Part Four teaches you how to register a business, write contracts, price your work, and build multiple revenue streams. One course. Complete transformation."],
  ["60+ Real-World Examples", "Not abstract theory. Real scenarios: the wedding where NEPA took the light, the church that banned flash, the Computer Village buyer who overpaid N50K, the N5,000 product setup that delivers N50K results."],
  ["45+ Practice Exercises", "Every section ends with a hands-on assignment. The Aperture Experiment. The Street Photography Walk. The Brutal Portfolio Cull. The 90-Day Business Plan. You learn by doing, not just watching."],
  ["From Someone Who Did It", "From dispatch rider to photographer, cinematographer, and production specialist. Not someone who read about photography. Someone who has shot in the worst Nigerian conditions and delivered every time."],
  ["Priced to Change Lives", "At \u20A615,000, this costs less than two tanks of fuel. The same knowledge that took years and hundreds of thousands of Naira in mistakes. Priced for impact, not extraction."],
];

const JOURNEY_DATA = [
  { part: "PART ONE", title: "Foundations", chs: "Chapters 1\u20135", desc: "Camera mastery, exposure triangle, composition, and light", color: "#2D6A4F" },
  { part: "PART TWO", title: "Building Your Craft", chs: "Chapters 6\u20137", desc: "Lenses, post-processing, editing workflow, and style", color: "#40916C" },
  { part: "PART THREE", title: "Advanced Techniques", chs: "Chapters 8\u201311", desc: "Genre mastery, advanced lighting, composition, and retouching", color: "#C8A24E" },
  { part: "PART FOUR", title: "The Business", chs: "Chapters 12\u201316", desc: "Pricing, contracts, marketing, scaling, ethics, and your 90-day plan", color: "#B8860B" },
];
...
const STATS_DATA = [["16","Chapters"],["4","Structured Parts"],["60+","Real Examples"],["45+","Exercises"],["24K+","Words"],["Lifetime","Access"],["\u20A615K","One Payment"]];
...
// ═══ SVG ICONS ═══
const starSVG = '<svg width="14" height="14" viewBox="0 0 24 24" fill="#C8A24E"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>';
const checkSVG = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C8A24E" stroke-width="2.5" style="flex-shrink:0;margin-top:2px"><path d="M20 6L9 17l-5-5"/></svg>';
const chevSVG = '<svg class="ch-chevron" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#666" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>';
const lessonIcon = '<svg class="topic-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#C8A24E" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M9 12l2 2 4-4"/></svg>';
const exerciseIcon = '<svg class="topic-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#40916C" stroke-width="2"><path d="M12 20h9M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>';
const exampleIcon = '<svg class="topic-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#B8860B" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M14.31 8l5.74 9.94M9.69 8h11.48M7.38 12l5.74-9.94M9.69 16L3.95 6.06M14.31 16H2.83M16.62 12l-5.74 9.94"/></svg>';
const plusSVG = '<svg class="faq-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#666" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>';

// ═══ RENDER FUNCTIONS ═══
function renderBrands() {
  const el = document.getElementById('brandLogos');
  el.innerHTML = BRANDS.map(b => 
    `<div class="brand-item"><div class="brand-icon" style="background:${b.color}">${b.name.charAt(0)}</div><span class="brand-name">${b.name}</span></div>`
  ).join('');
}

function renderStats() {
  const el = document.getElementById('statsGrid');
  el.innerHTML = STATS_DATA.map(([v, l]) => `<div class="stat-item"><div class="stat-val">${v}</div><div class="stat-label">${l}</div></div>`).join('');
}
...
function renderModules() {
  ...
  MODULES.forEach((mod, mi) => {
    ...
    mod.chapters.forEach(ch => {
      ...
      html += `<div class="ch-card${isFirst ? ' open' : ''}" data-ch="${ch.num}">`;
...
function renderDifferent() {
  ...
  el.innerHTML = DIFF_DATA.map(([t, d]) => `<div class="diff-card"><div class="diff-accent"></div><h3>${t}</h3><p>${d}</p></div>`).join('');
}

function renderJourney() {
  const el = document.getElementById('journeyGrid');
  el.innerHTML = JOURNEY_DATA.map(j => `<div class="journey-card" style="border-top:3px solid ${j.color}"><div class="j-part" style="color:${j.color}">${j.part}</div><h3>${j.title}</h3><div class="j-chs">${j.chs}</div><p>${j.desc}</p></div>`).join('');
}

function renderTestimonials() {
  const el = document.getElementById('testGrid');
  el.innerHTML = TESTIMONIALS.map(t => `<div class="tcard"><div class="stars">${starSVG.repeat(5)}</div><p class="t-text">\u201C${t.text}\u201D</p><div><span class="t-name">${t.name}</span><span class="t-loc">${t.location}</span></div></div>`).join('');
}

function renderPricing() {
  const el = document.getElementById('priceFeatures');
  el.innerHTML = PRICE_FEATURES.map(f => `<div class="pf-item">${checkSVG}<span>${f}</span></div>`).join('');
}

function renderFAQ() {
  const el = document.getElementById('faqContainer');
  el.innerHTML = FAQ_DATA.map((f, i) => `<div class="faq-item" data-faq="${i}"><div class="faq-q"><h3>${f.q}</h3>${plusSVG}</div><div class="faq-a"><p>${f.a}</p></div></div>`).join('');
}
...
function setupChapterToggles() {
  document.querySelectorAll('.ch-card').forEach(card => {
    card.addEventListener('click', () => {
      ...
      document.querySelectorAll('.ch-card.open').forEach(c => c.classList.remove('open'));
...
function setupScrollAnimations() {
  ...
  document.querySelectorAll('.anim-section').forEach(section => observer.observe(section));
}

// ═══ REGISTRATION FORM HANDLER ═══
function handleRegistration() {
  // Clear previous errors
  document.querySelectorAll('.reg-field').forEach(f => f.classList.remove('error'));
  ...
  // Validate
  if (!firstName) { showFieldError('regFirst', 'Enter your first name'); hasError = true; }
  if (!lastName) { showFieldError('regLast', 'Enter your last name'); hasError = true; }
  if (!email || !email.includes('@') || !email.includes('.')) { showFieldError('regEmail', 'Enter a valid email address'); hasError = true; }
  if (!phone || phone.length < 10) { showFieldError('regPhone', 'Enter a valid phone number'); hasError = true; }
  if (!level) { showFieldError('regLevel', 'Select your level'); hasError = true; }
  ...
  const registrationData = {
    firstName, lastName, email, phone, level,
    timestamp: new Date().toISOString(),
    source: 'masterclass_landing_page'
  };

  // ═══ SEND TO GOOGLE SHEETS ═══
  const GOOGLE_SHEET_URL = 'https://script.google.com/macros/s/AKfycbynRugjw_1ryCl7iX126vg4VBqQ2_i7IMknKFZYLhCvH0rVXMn6pxFhBYY6UYmYtakS/exec';
  ...
  .then(() => {
    ...
    // Show success message briefly then redirect to Paystack
    document.getElementById('regSuccess').style.display = 'block';

    // Redirect to Paystack payment page after 2 seconds
    setTimeout(() => { window.location.href = 'https://paystack.com/buy/masterclass-fqsjff'; }, 2000);
  })
  .catch((error) => {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.addEventListener('input', (e) => {
    const field = e.target.closest('.reg-field');
    if (field) {
  ...
  // Clear field errors when user changes select
  ...
  // Backup click handler for the submit button (in case inline onclick fails)
